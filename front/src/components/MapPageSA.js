...
import TankMap from './TankMap'; // Importing TankMap component
import { useNavigate, useLocation } from 'react-router-dom';
import 'leaflet/dist/leaflet.css';

// MapPageSA component for displaying Simulated Annealing results
const MapPageSA = () => {
  // React Router hook for navigation
  const navigate = useNavigate();

  // Navigation handlers to different pages
  const handleNavigateToPlanningSA = () => {
    ...
    <div className="App">
      <div style={{ display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center" }}>
        ...
        <div className='title' style={{ display: 'flex', justifyContent: "space-around", flexDirection: 'row', marginTop: "10px" }}>
          <h1 style={{ marginBottom: '20px',fontSize: '40px'}}>Simulated Annealing Map</h1>
        </div>
          ...
          <div className='navigation-panel' style={{ display: 'flex', justifyContent: 'center', marginBottom: '30px', marginTop: "0px", height: "200px" }}>
            ...
            <div className='data-and-button' style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
              <div className='data-table' style={{ display: "flex", flexDirection: "row",borderRadius: '19px', border: '2px solid grey', overflow: 'hidden'  }}>
                <table style={{ borderCollapse: 'collapse', borderRadius: '19px', backgroundColor: "#E3E1D9" }}>
                  <thead>
                    <tr>
              ...
              <div style={{
                ...
                {/* Simulated Annealing Schedule Button */}
                <button onClick={handleNavigateToPlanningSA} style={{
                ...
                {/* Hill Climbing Map Button */}
                <button onClick={handleNavigateToMapPageHC} style={{
                  backgroundColor: '#000000',
                  color: '#fff',
                  padding: '20px 15px',
                  border: 'none',
