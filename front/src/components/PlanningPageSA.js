...
const PlanningPageSA = () => {
  ...
  const handleNavigateToHCSchedule = () => {
  ...
  return (
    <div className="page" style={{ display: "flex", justifyContent: "center", alignItems: "center", flexDirection: "column" }}>
      ...
      <div className='title' style={{ marginTop: '10px', textAlign: 'center' }}>
        <h1 style={{ color: 'black', fontSize: '40px' }}>Simulated Annealing Schedule</h1>
      </div>
      ...
      <div className="planning-block" style={{ backgroundColor: '#333', color: '#fff', padding: '20px', borderRadius: "19px" }}>
        ...
        <div className="planning-container">
          {result.simulated_annealing_results && (
            currentJourney[currentJourneyIndexInList].cycles.map((cycle, cycleIndex) => (
              <div className="cycle_containers" key={cycleIndex} style={{
                backgroundColor: '#888',
      ...
      {/* Navigation buttons */}
      <div className='navigation-buttons' style={{ display: "flex", flexDirection: "row", justifyContent: "space-evenly", width: "47%", marginTop: "2%", marginBottom: "2%" }}>
        <button
        ...
        <button
          onClick={handleNavigateToHCSchedule}
          style={{
            backgroundColor: '#000000',
            color: '#fff',
            padding: '20px 15px',
